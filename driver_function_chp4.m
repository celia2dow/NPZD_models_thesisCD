% Run set for producing numerous figures for chapter 4 - E&B set functions
clear
close all
    ...
    for i = 0:1     
        ...
        for j = 0:1 
            ...
            for d = [1, 1.5]  
                ...
                %%%%%%%%%%% NEXT TILE %%%%%%%%%%%%%%%%%
                nexttile(tiles);
                max_y = max(record.soluts(1,1,:,condit_afterBI),[],'all');
