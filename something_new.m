% Plot time series trajectories no burn-in
...
% burn in year plots
nexttile(tiles,(state_var-1)*2+1);
plot(x_vals2,c.min(condit_afterBI), 'LineStyle', '-', ...
    'Color', cols{state_var}, 'LineWidth', 2); % Min
